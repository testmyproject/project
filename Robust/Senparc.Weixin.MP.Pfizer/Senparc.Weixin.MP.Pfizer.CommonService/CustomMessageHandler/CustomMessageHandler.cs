...
//using Senparc.Weixin.MP.Pfizer.CommonService;
...
namespace Senparc.Weixin.MP.Pfizer.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            else if (requestMessage.Content == "setmenu")
            {
                CustomMenuHandler menuHandler = new CustomMenuHandler();
                responseMessage.Content = menuHandler.CreateMenu();

            }
            else if (string.Compare(requestMessage.Content.Substring(0,2),"RZ",true)==0)
            {
                WeiXinUser WeiXinUser = new WeiXinUser();
                if (WeiXinUser.IsCertified(requestMessage.FromUserName))
                    responseMessage.Content = "已认证！";
                else
                    responseMessage.Content = "未认证！";
