...
using Senparc.Weixin.MP.Pfizer.Controllers;
using Senparc.Weixin.MP.Pfizer.Tests.Mock;

namespace Senparc.Weixin.MP.Pfizer.Tests.Controllers
{
    //已通过测试
    [TestClass]
...
<xml>
  ...
  <Video>
    ...
    <ThumbMediaId><![CDATA[thumbMediaId]]></ThumbMediaId>
        ...
        [TestMethod]
        public void ClickEvent_Pfizer_Help()
        {
            //按钮测试-图文
            var xml = string.Format(string.Format(xmlEvent_ClickFormat, "Pfizer_Help"), DateTimeHelper.GetWeixinDateTime(DateTime.Now));
            Init(xml);//初始化
